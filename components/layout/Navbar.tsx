        ...
        <div className="flex md:hidden items-center gap-2">
          {mounted ? (
            <>
              ...
              {/* Sheet de Navegación Lateral Móvil Ooasys */}
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                ...
                <SheetContent side="right" className="w-75 sm:w-87.5 overscroll-contain bg-white dark:bg-[#1C1917] border-l border-[#E7E5E4] dark:border-[#44403C]">
                  ...
                  <nav className="flex flex-col gap-2 mt-8">
                    ...
                    {user ? (
                      isAgent ? (
                        <Link href="/dashboard" onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-4 py-3 text-base font-medium rounded-lg text-[#44403C] dark:text-[#D6D3D1] hover:text-[#14B8A6] hover:bg-[#14B8A6]/10 transition-all">
                          <LayoutDashboard className="h-5 w-5" /> Dashboard
                        </Link>
                      ) : (
                        <Link href="/pricing" onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-4 py-3 text-base font-medium rounded-lg text-[#44403C] dark:text-[#D6D3D1] hover:text-[#14B8A6] hover:bg-[#14B8A6]/10 transition-all">Registrar negocio</Link>
                      )
                    ) : (
                      <Link href="/pricing" onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-4 py-3 text-base font-medium rounded-lg text-[#44403C] dark:text-[#D6D3D1] hover:text-[#14B8A6] hover:bg-[#14B8A6]/10 transition-all">Registrar negocio</Link>
                    )}
                    ...
                    {!user && (
                      <>
                        ...
                        <div className="flex flex-col gap-2 px-4 mt-2">
                          <SignInButton mode="modal"><Button variant="outline" className="w-full border-[#14B8A6] text-[#14B8A6] hover:bg-[#14B8A6]/10" onClick={() => setIsOpen(false)}>Iniciar sesión</Button></SignInButton>
                          <SignUpButton mode="modal"><Button className="w-full bg-[#14B8A6] hover:bg-[#0F766E] text-white" onClick={() => setIsOpen(false)}>Crear cuenta</Button></SignUpButton>
                        </div>
                      </>
                    )}
                  </nav>
